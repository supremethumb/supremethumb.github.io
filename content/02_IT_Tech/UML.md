...
date: 2026-04-13
tags: ["IT", "개발", "기술"]
description: "객체 지향, 표준화된 범용 모델링 언어"
---
...
- 관계
    - 연관관계(Association)
        - 연관 관계는 2 개 이상의 사물이 서로 관련된 상태를 표현
...
- 스테레오 타입
    ...
    - 유형
        ...
        - <<interface>>
            - 모든 메소드가 추상 메소드이며. 바로 인스턴스 를 만들 수 없는 클래스로 추상 메소드와 상수만으로 구성된 클래스
        - <<entity>>
...
- [[02_IT_Tech/객체|객체]] — 공유 키워드: `IT`, `객체`
- [[02_IT_Tech/객체지향|객체지향]] — 공유 키워드: `IT`, `객체`
- [[02_IT_Tech/나씨-슈나이더만|나씨-슈나이더만]] — 공유 키워드: `IT`, `표현`
- [[02_IT_Tech/디자인 패턴|디자인 패턴]] — 공유 키워드: `IT`, `객체`
